...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--exp_name", default="Ours", type=str, help="The name for this batch of experiments."
    )
    ...
    experiment_batch_name = "{}_0530_newmiss".format(args.exp_name)
    ...
    model.learn(
        ...
        save_buffer=False,
        load_buffer=False,
        save_path_human = Path(log_dir) / Path("human_buffer_0530_ours_" + str(seed)),
        save_path_replay = Path(log_dir) / Path("novice_buffer_0530_ours_" + str(seed)),
    )
