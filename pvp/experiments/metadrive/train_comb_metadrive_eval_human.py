...
if __name__ == '__main__':
    ...
    if config["env_config"]["use_render"]:
        ...
        eval_env, eval_freq = SubprocVecEnv([_make_eval_env]), 1
    ...
    if True:
        ckpt = "/home/caihy/pvp/runs/Ours_bcw=1.0_L=3_0502_Real/Ours_bcw=1.0_L=3_0502_Real_0d20cc4e/best_model.zip"
