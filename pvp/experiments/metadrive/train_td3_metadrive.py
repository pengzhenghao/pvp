...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_name", default="td3w1bcw0.1", type=str, help="The name for this batch of experiments.")
    ...
    parser.add_argument("--ckpt", default="/home/caihy/pvp/cnnbestdrive84.zip", type=str, help="Path to previous checkpoint.")
    ...
    # ===== Setup the callbacks =====
    callbacks = [
        CheckpointCallback(name_prefix="rl_model", verbose=1, save_freq=2500, save_path=str(trial_dir / "models"))
    ]
    if use_wandb:
        callbacks.append(
            WandbCallback(
