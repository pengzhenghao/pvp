...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt", default="/home/caihy/pvp/pvp/123.zip", type=str, help="Path to previous checkpoint.")
    ...
    # ===== Setup the callbacks =====
    callbacks = [
        CheckpointCallback(name_prefix="rl_model", verbose=1, save_freq=1000, save_path=str(trial_dir / "models"))
    ]
    if use_wandb:
        callbacks.append(
            WandbCallback(
