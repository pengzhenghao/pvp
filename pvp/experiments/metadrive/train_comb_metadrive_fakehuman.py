...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt", default="ILinit", type=str)
    ...
    model.learn(
        ...
        log_interval=1,
        save_buffer=True,
        save_path_human="1119v3pref500expert1ktakeoverSR0.9L=3",
        save_path_replay="1119v3pref500expert1ktakeoverSR0.9L=3",
