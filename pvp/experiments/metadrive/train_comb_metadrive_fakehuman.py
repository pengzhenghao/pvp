...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--exp_name", default="TD3BC", type=str, help="The name for this batch of experiments."
    )
    ...
    parser.add_argument("--ckpt", default="ILinit.zip", type=str)
    ...
    experiment_batch_name = "{}_bcw={}_0926".format("TD3BC", args.bc_loss_weight)
    ...
    eval_env, eval_freq = SubprocVecEnv([_make_eval_env] * 1), 100
