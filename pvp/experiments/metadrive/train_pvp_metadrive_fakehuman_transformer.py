...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--exp_name", default="pvp_transformer", type=str, help="The name for this batch of experiments."
    )
    parser.add_argument("--learning_starts", default=200, type=int)
    parser.add_argument("--save_freq", default=500, type=int)
    parser.add_argument("--seed", default=0, type=int, help="The random seed.")
    parser.add_argument("--wandb", action="store_true", help="Set to True to upload stats to wandb.")
    parser.add_argument("--wandb_project", type=str, default="transformer", help="The project name for wandb.")
    parser.add_argument("--wandb_team", type=str, default="victorique", help="The team name for wandb.")
    parser.add_argument("--log_dir", type=str, default="/home/caihy/pvp/runs", help="Folder to store the logs.")
    ...
    parser.add_argument("--ckpt", default="", type=str)   #/home/caihy/pvp/runs/runs/pvp_metadrive_fakehuman_freelevel0.95/pvp_metadrive_fakehuman_freelevel0.95_2025-10-05_12-15-40_08529fca/models/rl_model_50000_steps.zip
