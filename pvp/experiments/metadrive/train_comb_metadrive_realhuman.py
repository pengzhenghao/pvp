...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", default=1024, type=int) # Reduce the batch size for real-time copilot
    ...
    experiment_batch_name = "{}_bcw={}_L={}_0502_Real".format("Ours", args.bc_loss_weight, args.future_steps_preference)
    ...
    eval_env, eval_freq = SubprocVecEnv([_make_eval_env] * 1), 50000
