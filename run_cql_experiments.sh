#!/bin/bash
# ============================================================
# CQL (Conservative Q-Learning) Experiments - Adaptive GPU Version
# 自动适应可用的 GPU 数量
# ============================================================
...
echo "============================================================"
echo "Starting CQL Experiments (Adaptive GPU Mode)"
echo "============================================================"
...
if [ "$FAST_MODE" == "true" ]; then
    ...
    wait
    echo "CQL fast mode experiment completed!"
else
    ...
    echo ""
    echo "============================================================"
    echo "All ${TOTAL_DATA_SIZES} CQL experiments completed!"
fi
