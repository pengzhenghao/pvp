#!/bin/bash
#SBATCH --job-name=eval-fix6k-test
#SBATCH --partition=gpu06
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=20
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=/p0/user/caihy/pvp/logs/eval_fixed6k_test_%j.out
#SBATCH --error=/p0/user/caihy/pvp/logs/eval_fixed6k_test_%j.err
...
echo "=========================================="
echo "IQL Fixed BC-Div Step 6000 - TEST SEEDS"
echo "=========================================="
echo ""
