#!/bin/bash
#SBATCH --job-name=eval-iql-test
#SBATCH --partition=gpu06
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=20
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=/p0/user/caihy/pvp/logs/%j_eval_iql_test.out
#SBATCH --error=/p0/user/caihy/pvp/logs/%j_eval_iql_test.err

# Usage: sbatch run_eval_fixed6k_test_seeds.sh <checkpoint_path> <step_number>
# Example: sbatch run_eval_fixed6k_test_seeds.sh /data/caihy/iql_ckpts/iql_step_001000.zip 001000
...
echo "=========================================="
echo "${MODEL_PREFIX} Evaluation - Step ${STEP} - TEST SEEDS"
echo "=========================================="
...
echo "  Seeds: TOP 200 HARD in [1000, 2000)"
echo "=========================================="
echo ""
...
python eval_bc_checkpoint.py \
    ...
    --exp_name "${MODEL_PREFIX}_step${STEP}_test"
