#!/bin/bash
# ============================================================
# Pure BC (Behavioral Cloning) Experiments - Adaptive GPU Version
# 自动适应可用的 GPU 数量
# ============================================================
...
echo "============================================================"
echo "Starting Pure BC Experiments (Adaptive GPU Mode)"
echo "============================================================"
...
if [ "$FAST_MODE" == "true" ]; then
    ...
    wait
    echo "BC fast mode experiment completed!"
else
    ...
    echo ""
    echo "============================================================"
    echo "All ${TOTAL_DATA_SIZES} BC experiments completed!"
fi
